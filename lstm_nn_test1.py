...
def fun(TIME_STEPS,
    ...
    class LSTMRNN(object):
        ...
        def add_cell(self):
            lstm_cell = tf.contrib.rnn.BasicLSTMCell(self.cell_size, forget_bias=0.0, state_is_tuple=True)
        ...
        def add_nn_layer(self,inputs,in_size,out_size,activation_function=None):
            ...
            stddev = 2 / np.sqrt(in_size+out_size)
            Weights = tf.Variable(tf.truncated_normal((in_size, out_size), stddev=stddev))
